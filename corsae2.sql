...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2024 a las 22:56:19
...
(72, 'uploads/favicon7.png', 'Contabilidad', 'contabilidad@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', '', '112');
...
(2, '1', '1', '1721080800', '10:20 AM To 10:40 AM', '10:20 AM', '10:40 AM', '', '07/01/24', '1719805797', '124', 'Pending Confirmation', '1', '', 'Marco Antonio  Lopez Perez', 'Optometrista 1', 'hms-meeting-+522211636228-968744', 'https://meet.jit.si/hms-meeting-+522211636228-968744', '1721118000', '16-07-2024 10:20 AM-10:40 AM');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `autoemailshortcode`
--
...
--
-- Volcado de datos para la tabla `autoemailshortcode`
--
...
--
-- Estructura de tabla para la tabla `autoemailtemplate`
--
...
--
-- Volcado de datos para la tabla `autoemailtemplate`
--
...
--
-- Estructura de tabla para la tabla `autosmsshortcode`
--
...
--
-- Volcado de datos para la tabla `autosmsshortcode`
--
...
--
-- Estructura de tabla para la tabla `autosmstemplate`
--
...
--
-- Volcado de datos para la tabla `autosmstemplate`
--
...
(1, 'uploads/doctor-icon-avatar-white136162-586.jpg', 'Optometrista 1', 'optometrista1@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', 'Cardiology', 'Optometrista', '', '', '709');
...
(89, 'Gastos Generales', '1719683869', 'Compra de liquido', '100', '1', '29/06/24'),
(90, 'Papeleria', '1719789891', 'Compra de rollo termico', '200', '1', '01/07/24');
...
(59, 'Gastos Generales', 'Gastos Generales', NULL, NULL),
(60, 'Papeleria', 'Gastos de Papeleria', NULL, NULL);
...
(3, 'uploads/favicon1.png', 'Laboratorio', 'laboratorio@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', '', '', '111');
...
--
-- Estructura de tabla para la tabla `manualemailshortcode`
--
...
--
-- Volcado de datos para la tabla `manualemailshortcode`
--
...
--
-- Estructura de tabla para la tabla `manualsmsshortcode`
--
...
--
-- Volcado de datos para la tabla `manualsmsshortcode`
--
...
--
-- Estructura de tabla para la tabla `manual_email_template`
--
...
--
-- Volcado de datos para la tabla `manual_email_template`
--
...
--
-- Estructura de tabla para la tabla `manual_sms_template`
--
...
--
-- Volcado de datos para la tabla `manual_sms_template`
--
...
(2880, 'Armazon Gray', 'Armazones de Metal', '100', '1', '150', 4, 'Armazon Gray', 'Optica1', 'Ninguno', '31-07-2025', '06/28/24'),
(2881, 'Armazon Orange', 'Armazones de Plastico', '100', '1', '150', 5, 'Armazon Orange', 'Optica1', 'Ninguno', '30-09-2025', '06/28/24');
...
(25, 'Armazones de Metal', 'Armazones de metal'),
(26, 'Micas', 'micas de cristal'),
(27, 'Armazones de Plastico', 'armazones de plastico');
...
--
-- Estructura de tabla para la tabla `meeting_settings`
--
...
--
-- Volcado de datos para la tabla `meeting_settings`
--
...
(8, 'uploads/favicon4.png', 'Emfermera', 'emfermera@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', '', '', '', '109');
...
(85, '1', 'None', '123', 'None', '125', 'dbdbd', '', '1000', '0', '1000', '', '', '', '', '', '1506195494', '2000', '2000', '0', '2000', '', '1000', 'unpaid', '614');
...
(1, 'uploads/doctor-icon-avatar-white136162-5821.jpg', 'Marco Antonio  Lopez Perez', 'mm_marco_mar@hotmail.com', '1', 'Dalias 6124 Bugambilias', '+522211636228', 'Masculino', '18-06-1997', '', 'A+', '681', '101223', '01/30/19', '', ''),
(2, NULL, 'Luis Arturo Robles', 'luisarturorobles100@gmail.com', '1', 'Calle 6 oriente num4', '+522211636228', 'Maculino', '16-02-2000', NULL, 'A+', '1584', '636980', '06/29/24', '1719681052', NULL),
(3, 'uploads/why-choose-us-doc1.png', 'Carlos Daniel F', 'prueba@gmail.com', '1', 'Calle 6 oriente num4', '2214229899', 'Femenino', '18-07-1997', NULL, NULL, '1585', '34110', '07/17/24', '1721240592', NULL);
...
(129, 'Consulta', 'Consulta General de Optometria', '50', 'diagnostic', 10, NULL);
...
(7, 'uploads/favicon6.png', 'Farmacia', 'farmacia@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', '', '', '110');
...
--
-- Volcado de datos para la tabla `pharmacy_payment`
--
...
(3, NULL, NULL, NULL, '1721333679', '150', '0', NULL, NULL, '', '', '150', NULL, NULL, NULL, '2880*150*1*100', NULL, 'unpaid');
...
(101, '1721253600', '1', '1', '', '', NULL, NULL, '2880***0***0***0***0', NULL, '', 'Marco Antonio  Lopez Perez', 'Optometrista 1');
...
(7, '', 'Recepcionista', 'recepcionista@corsae.com.mx', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', '', '614');
...
(1, 'Corsae', 'Corsae', 'Boulevard Municipio Libre 1826 Colonia Universidades', '+522216451545', 'atencion@corsae.com.mx', '#', '$', 'spanish', 'flat', 'jitsi', 'percentage', 'Login Title', 'uploads/logo2.png', '', 'PayPal', 'Twilio', '', '', 'America/Chihuahua', 'Domain Email', '', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `site_gallery`
--
...
--
-- Volcado de datos para la tabla `site_gallery`
--
...
--
-- Estructura de tabla para la tabla `site_grid`
--
...
--
-- Volcado de datos para la tabla `site_grid`
--
...
--
-- Estructura de tabla para la tabla `site_review`
--
...
--
-- Volcado de datos para la tabla `site_review`
--
...
(100, '1719552735', '{firstname} come to my offce {lastname}', 'Patient Id: 1<br> Patient Name: Mr Patient<br> Patient Phone: +522211636228', '1');
...
--
-- Volcado de datos para la tabla `time_schedule`
--

INSERT INTO `time_schedule` (`id`, `doctor`, `weekday`, `s_time`, `e_time`, `s_time_key`, `duration`) VALUES
(124, '1', 'Wednesday', '10:00 AM', '03:00 PM', '120', '4'),
(122, '1', 'Monday', '10:00 AM', '03:00 PM', '120', '4'),
(123, '1', 'Tuesday', '10:00 AM', '03:00 PM', '120', '4'),
(125, '1', 'Thursday', '10:00 AM', '03:00 PM', '120', '4'),
(126, '1', 'Friday', '10:00 AM', '03:00 PM', '120', '4');
...
(2542, '1', '02:00 PM', '02:20 PM', 'Tuesday', '168'),
(2541, '1', '01:40 PM', '02:00 PM', 'Tuesday', '164'),
(2540, '1', '01:20 PM', '01:40 PM', 'Tuesday', '160'),
(2539, '1', '01:00 PM', '01:20 PM', 'Tuesday', '156'),
(2538, '1', '12:40 PM', '01:00 PM', 'Tuesday', '152'),
(2537, '1', '12:20 PM', '12:40 PM', 'Tuesday', '148'),
(2536, '1', '12:00 PM', '12:20 PM', 'Tuesday', '144'),
(2535, '1', '11:40 AM', '12:00 PM', 'Tuesday', '140'),
(2547, '1', '10:40 AM', '11:00 AM', 'Wednesday', '128'),
(2546, '1', '10:20 AM', '10:40 AM', 'Wednesday', '124'),
(2545, '1', '10:00 AM', '10:20 AM', 'Wednesday', '120'),
(2544, '1', '02:40 PM', '03:00 PM', 'Tuesday', '176'),
(2543, '1', '02:20 PM', '02:40 PM', 'Tuesday', '172'),
(2534, '1', '11:20 AM', '11:40 AM', 'Tuesday', '136'),
(2533, '1', '11:00 AM', '11:20 AM', 'Tuesday', '132'),
(2532, '1', '10:40 AM', '11:00 AM', 'Tuesday', '128'),
(2531, '1', '10:20 AM', '10:40 AM', 'Tuesday', '124'),
(2530, '1', '10:00 AM', '10:20 AM', 'Tuesday', '120'),
(2529, '1', '02:40 PM', '03:00 PM', 'Monday', '176'),
(2528, '1', '02:20 PM', '02:40 PM', 'Monday', '172'),
(2527, '1', '02:00 PM', '02:20 PM', 'Monday', '168'),
(2526, '1', '01:40 PM', '02:00 PM', 'Monday', '164'),
(2525, '1', '01:20 PM', '01:40 PM', 'Monday', '160'),
(2524, '1', '01:00 PM', '01:20 PM', 'Monday', '156'),
(2523, '1', '12:40 PM', '01:00 PM', 'Monday', '152'),
(2522, '1', '12:20 PM', '12:40 PM', 'Monday', '148'),
(2521, '1', '12:00 PM', '12:20 PM', 'Monday', '144'),
(2520, '1', '11:40 AM', '12:00 PM', 'Monday', '140'),
(2519, '1', '11:20 AM', '11:40 AM', 'Monday', '136'),
(2518, '1', '11:00 AM', '11:20 AM', 'Monday', '132'),
(2517, '1', '10:40 AM', '11:00 AM', 'Monday', '128'),
(2516, '1', '10:20 AM', '10:40 AM', 'Monday', '124'),
(2515, '1', '10:00 AM', '10:20 AM', 'Monday', '120'),
(2555, '1', '01:20 PM', '01:40 PM', 'Wednesday', '160'),
(2554, '1', '01:00 PM', '01:20 PM', 'Wednesday', '156'),
(2553, '1', '12:40 PM', '01:00 PM', 'Wednesday', '152'),
(2552, '1', '12:20 PM', '12:40 PM', 'Wednesday', '148'),
(2551, '1', '12:00 PM', '12:20 PM', 'Wednesday', '144'),
(2550, '1', '11:40 AM', '12:00 PM', 'Wednesday', '140'),
(2549, '1', '11:20 AM', '11:40 AM', 'Wednesday', '136'),
(2548, '1', '11:00 AM', '11:20 AM', 'Wednesday', '132'),
(2556, '1', '01:40 PM', '02:00 PM', 'Wednesday', '164'),
(2557, '1', '02:00 PM', '02:20 PM', 'Wednesday', '168'),
(2558, '1', '02:20 PM', '02:40 PM', 'Wednesday', '172'),
(2559, '1', '02:40 PM', '03:00 PM', 'Wednesday', '176'),
(2560, '1', '10:00 AM', '10:20 AM', 'Thursday', '120'),
(2561, '1', '10:20 AM', '10:40 AM', 'Thursday', '124'),
(2562, '1', '10:40 AM', '11:00 AM', 'Thursday', '128'),
(2563, '1', '11:00 AM', '11:20 AM', 'Thursday', '132'),
(2564, '1', '11:20 AM', '11:40 AM', 'Thursday', '136'),
(2565, '1', '11:40 AM', '12:00 PM', 'Thursday', '140'),
(2566, '1', '12:00 PM', '12:20 PM', 'Thursday', '144'),
(2567, '1', '12:20 PM', '12:40 PM', 'Thursday', '148'),
(2568, '1', '12:40 PM', '01:00 PM', 'Thursday', '152'),
(2569, '1', '01:00 PM', '01:20 PM', 'Thursday', '156'),
(2570, '1', '01:20 PM', '01:40 PM', 'Thursday', '160'),
(2571, '1', '01:40 PM', '02:00 PM', 'Thursday', '164'),
(2572, '1', '02:00 PM', '02:20 PM', 'Thursday', '168'),
(2573, '1', '02:20 PM', '02:40 PM', 'Thursday', '172'),
(2574, '1', '02:40 PM', '03:00 PM', 'Thursday', '176'),
(2575, '1', '10:00 AM', '10:20 AM', 'Friday', '120'),
(2576, '1', '10:20 AM', '10:40 AM', 'Friday', '124'),
(2577, '1', '10:40 AM', '11:00 AM', 'Friday', '128'),
(2578, '1', '11:00 AM', '11:20 AM', 'Friday', '132'),
(2579, '1', '11:20 AM', '11:40 AM', 'Friday', '136'),
(2580, '1', '11:40 AM', '12:00 PM', 'Friday', '140'),
(2581, '1', '12:00 PM', '12:20 PM', 'Friday', '144'),
(2582, '1', '12:20 PM', '12:40 PM', 'Friday', '148'),
(2583, '1', '12:40 PM', '01:00 PM', 'Friday', '152'),
(2584, '1', '01:00 PM', '01:20 PM', 'Friday', '156'),
(2585, '1', '01:20 PM', '01:40 PM', 'Friday', '160'),
(2586, '1', '01:40 PM', '02:00 PM', 'Friday', '164'),
(2587, '1', '02:00 PM', '02:20 PM', 'Friday', '168'),
(2588, '1', '02:20 PM', '02:40 PM', 'Friday', '172'),
(2589, '1', '02:40 PM', '03:00 PM', 'Friday', '176');
...
(1, '127.0.0.1', 'Administrador', '$2y$08$hvhOkpWRZVsH2zKxjmXlQ.tW28eSpVH30VBILvCY.PNQtmjL6j7jm', '', 'admin@corsae.com.mx', '', 'g0wt205VJVb4a9819f14ce3d10dffe14f93680e2', 1607595309, 'zCeJpcj78CKqJ4sVxVbxcO', 1268889823, 1721492782, 1, 'Admin', 'istrator', 'ADMIN', '0'),
(109, '113.11.74.192', 'Emfermera', '$2y$08$8wqEbhIeB2Q7zn0.3hTKq.e./6WWwYkWmpimIp6x3C2rDljqPE1dC', NULL, 'emfermera@corsae.com.mx', NULL, NULL, NULL, NULL, 1435082243, 1614599494, 1, NULL, NULL, NULL, NULL),
(110, '113.11.74.192', 'Farmacia', '$2y$08$3tJOdsf/APgP75xr18IFAOZCW6Tie.dYnlYcS.Oq3uzmIGccr2962', NULL, 'farmacia@corsae.com.mx', NULL, NULL, NULL, 'mbeMop6vTuscFYmD2M4Iqu', 1435082359, 1719859886, 1, NULL, NULL, NULL, NULL),
(111, '113.11.74.192', 'Laboratorio', '$2y$08$bH0RWi8eL/jngPL0EVmeiOxUrAgsFjTcVDRnDUo.MlRo5tjVysHWC', NULL, 'laboratorio@corsae.com.mx', NULL, NULL, NULL, NULL, 1435082438, 1719859758, 1, NULL, NULL, NULL, NULL),
(112, '113.11.74.192', 'Contabilidad', '$2y$08$LSQIkblvlrQn.2K1WwrmCuducP7QxJ8NsPrDtTj7COT3/LjvDpEM6', NULL, 'contabilidad@corsae.com.mx', NULL, NULL, NULL, NULL, 1435082637, 1614599331, 1, NULL, NULL, NULL, NULL),
(614, '103.231.162.58', 'Recepcionista', '$2y$08$V5AgOGjTw5vgGPXFIChMk.Kj7QNC365wjwp.jakPbgEzJDh5wcFFq', NULL, 'recepcionista@corsae.com.mx', NULL, NULL, NULL, NULL, 1505800835, 1719859822, 1, NULL, NULL, NULL, NULL),
(681, '103.231.161.30', 'Marco Antonio  Lopez Perez', '$2y$08$MDHeQLF1KAfnREm008seSO5NJ5Ph73jrmxNcAVwQxQyl3C59lsFzC', NULL, 'mm_marco_mar@hotmail.com', NULL, NULL, NULL, NULL, 1548872582, 1719859333, 1, NULL, NULL, NULL, NULL),
(709, '103.231.160.47', 'Optometrista 1', '$2y$08$j02HkDpcRfSzNSubKAR81.RWSB9GJ.te4m.3FPqq4MsE523KDYTP2', NULL, 'optometrista1@corsae.com.mx', NULL, NULL, NULL, NULL, 1558379920, 1719860057, 1, NULL, NULL, NULL, NULL),
(1584, '::1', 'Luis Arturo Robles', '$2y$08$HgXRvp9Wo/.UqSMaQRBTweZksr2iNXWg.BJXOpo15ISq37OYchBIi', NULL, 'luisarturorobles100@gmail.com', NULL, NULL, NULL, NULL, 1719681052, NULL, 1, NULL, NULL, NULL, NULL),
(1585, '::1', 'Carlos Daniel F', '$2y$08$YMMVoMZE2FxMYiwSXF7dx.AbnISzqLPKShDjqJIIXHE/YUWx1xhE2', NULL, 'prueba@gmail.com', NULL, NULL, NULL, NULL, 1721240592, NULL, 1, NULL, NULL, NULL, NULL);
...
--
-- Indices de la tabla `autoemailshortcode`
--
ALTER TABLE `autoemailshortcode`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `autoemailtemplate`
--
ALTER TABLE `autoemailtemplate`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `autosmsshortcode`
--
ALTER TABLE `autosmsshortcode`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `autosmstemplate`
--
...
--
-- Indices de la tabla `manualemailshortcode`
--
ALTER TABLE `manualemailshortcode`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `manualsmsshortcode`
--
ALTER TABLE `manualsmsshortcode`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `manual_email_template`
--
ALTER TABLE `manual_email_template`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `manual_sms_template`
--
...
--
-- Indices de la tabla `meeting_settings`
--
...
--
-- Indices de la tabla `site_gallery`
--
ALTER TABLE `site_gallery`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `site_grid`
--
ALTER TABLE `site_grid`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `site_review`
--
...
--
-- AUTO_INCREMENT de la tabla `autoemailshortcode`
--
ALTER TABLE `autoemailshortcode`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT de la tabla `autoemailtemplate`
--
ALTER TABLE `autoemailtemplate`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `autosmsshortcode`
--
ALTER TABLE `autosmsshortcode`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT de la tabla `autosmstemplate`
--
ALTER TABLE `autosmstemplate`
...
--
-- AUTO_INCREMENT de la tabla `manualemailshortcode`
--
ALTER TABLE `manualemailshortcode`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `manualsmsshortcode`
--
ALTER TABLE `manualsmsshortcode`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `manual_email_template`
--
ALTER TABLE `manual_email_template`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `manual_sms_template`
--
ALTER TABLE `manual_sms_template`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT de la tabla `meeting_settings`
--
ALTER TABLE `meeting_settings`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `site_gallery`
--
ALTER TABLE `site_gallery`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `site_grid`
--
ALTER TABLE `site_grid`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `site_review`
--
ALTER TABLE `site_review`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `time_slot`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2590;

--
-- AUTO_INCREMENT de la tabla `users`
--
ALTER TABLE `users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1586;

--
-- AUTO_INCREMENT de la tabla `users_groups`
--
ALTER TABLE `users_groups`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5583;
