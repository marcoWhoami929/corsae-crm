                                ...
                                <table>
                                    <tr class="lasttr">
                                        ...
                                        <td style="font-size: 14px;">
                                            <li><strong><?php echo lang('sub_total'); ?> : </li>
                                        </td>
                                    ...
                                    <?php if (!empty($payment->discount)) { ?>
                                        ...
                                        <tr class="lasttr">
                                            ...
                                            <td style="width: 23%;"></td>
                                            <td style="font-size: 14px;">
                                                <li><strong><?php echo lang('discount'); ?> <?php echo $type; ?></strong></li>
                                            </td>
                                    ...
                                    <?php if (!empty($payment->vat)) { ?>
                                        ...
                                        <tr class="lasttr">
                                            ...
                                            <td style="width: 23%;"></td>
                                            <td style="font-size: 14px;">
                                                <li><strong>VAT :</strong></strong></li>
                                            </td>
                                        ...
                                        <tr class="lasttr">
                                            ...
                                            <td style="width: 23%;"></td>
                                            <td style="font-size: 14px;">
                                                <li><strong><?php echo lang('grand_total'); ?> : </strong></li>
                                            </td>
                                        ...
                                        <tr class="lasttr">
                                            ...
                                            <td style="width: 30%; font-size: 14px;">
                                                <li><strong><?php echo lang('amount_received'); ?> : </strong></li>
                                            </td>
                                        ...
                                        <tr class="lasttr">
                                            ...
                                            <td style="width: 20%;"></td>
                                            <td style="width: 30%; font-size: 14px;">
                                                <li><strong><?php echo lang('amount_to_be_paid'); ?> : </strong></li>
                                            </td>
