    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel col-md-8 row">
            <header class="panel-heading">
                <?php
                if (!empty($meeting->id))
                    echo lang('edit_meeting');
                else
                    echo lang('add_meeting');
                ?>
            </header>
            ...
            <div class="panel-body">
                ...
                <form role="form" action="meeting/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <?php if (empty($meeting->id)) { ?>
                        ...
                        <div class="col-md-12 panel">
                            ...
                            <div class="col-md-9">
                                <h5><?php echo $meeting->doctorname; ?></h5>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label">
                            <label for="topic"><?php echo lang('meeting'); ?> <?php echo lang('topic'); ?></label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" placeholder="<?php echo lang('meeting'); ?> <?php echo lang('topic'); ?>" class="form-control" value="<?php
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control" id="type" name="type">
                                ...
                                <option selected="" value="2">Scheduled Meeting</option>
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label">
                            <label for="time"><?php echo lang('start_time'); ?></label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" placeholder="<?php echo lang('start_time'); ?>" class="form_datetime form-control" name="start_time" value="<?php
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label">
                            <label for="duration"><?php echo lang('meeting_duration_minutes'); ?></label>
                        </div>
                        <div class="col-md-9">
                            <input type="number" placeholder="Meeting Duration" class="form-control" name="duration" value="<?php
                                                                                                                            if (!empty($meeting->duration)) {
                                                                                                                                echo $meeting->duration;
                                                                                                                            }
                                                                                                                            ?>" id="duration">
                        </div>
                    </div>
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label">
                            <label for="timezone"><?php echo lang('meeting'); ?> <?php echo lang('timezone'); ?></label>
                        </div>
                        <div class="col-md-9">
                            <select class="form-control js-example-basic-single" id="timezone" name="timezone">
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label">
                            <label for="password"><?php echo lang('meeting_password'); ?></label>
                        </div>
                        <div class="col-md-9">
                            <input type="password" placeholder="<?php echo lang('meeting_password'); ?>" class="form-control" name="meeting_password" value="<?php
                                                                                                                                                                if (!empty($meeting->meeting_password)) {
                                                                                                                                                                    echo $meeting->meeting_password;
                                                                                                                                                                }
                                                                                                                                                                ?>" id="password">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9"> 
                            <textarea type="text" class="form-control ckeditor" name="remarks" id="exampleInputEmail1" value='<?php
                                                                                                                                if (!empty($meeting->remarks)) {
                                                                                                                                    echo $meeting->remarks;
                                                                                                                                }
                    ...
                    <input type="hidden" name="id" id="meeting_id" value='<?php
                                                                            if (!empty($meeting->id)) {
                                                                                echo $meeting->id;
                                                                            }
                                                                            ?>'>
            ...
            $("#adoctors").change(function() {
                ...
                $.ajax({
                    ...
                    if ($('#aslots').has('option').length == 0) { //if it is blank. 
                        $('#aslots').append($('<option>').text('No hay horarios disponibles').val('Not Selected')).end();
                    }
