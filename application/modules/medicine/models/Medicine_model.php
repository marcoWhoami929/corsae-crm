...
class Medicine_model extends CI_model
{
    ...
    function insertMedicine($data, $dataOperations, $dataInventory)
    {
        $this->db->trans_start();
        $this->db->insert('medicine', $data);
        $product_id = $this->db->insert_id();
        $dataOperations['product_id'] = $product_id;
        $this->db->insert('operations', $dataOperations);
        $dataInventory['product_id'] = $product_id;
