...
class Doctor extends MX_Controller
{
    ...
    function getDoctor()
    {
        ...
        foreach ($data['doctors'] as $doctor) {
            ...
            $options2 = '<a class="btn btn-info btn-xs detailsbutton" title="' . lang('appointments') . '"  href="appointment/getAppointmentByDoctorId?id=' . $doctor->id . '"> <i class="fa fa-calendar"> </i> Actividades</a>';
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist'))) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist'))) {
                ...
                $options5 = '<a href="schedule/timeSchedule?doctor=' . $doctor->id . '" class="btn btn-info btn-xs btn_width" data-toggle="modal" data-id="' . $doctor->id . '"><i class="fa fa-clock"></i> ' . lang('time_schedule') . '</a>';
