                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist', 'Doctor'))) { ?>
                        <li id="header_notification_bar" class="dropdown">
                            ...
                            <ul class="dropdown-menu extended notification">
                                ...
                                <li>
                                    <p class="yellow"><?php
                                                        ...
                                                        if ($medicine_number <= 1) {
                                                            echo 'Productos registrados hoy';
                                                        } else {
                                                            echo 'Productos registrados hoy';
                                                        }
                                                        ?> </p>
                                ...
                                <li>
                                    <a href="medicine">
                                        <p class="green"><?php echo 'Ver todos los productos' ?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="doctor"><i class="fa fa-user"></i>Lista de Optometristas</a></li>
                                <li><a href="appointment/treatmentReport"><i class="fa fa-history"></i>Historial</a></li>
                            </ul>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Receptionist'))) { ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="schedule"><i class="fa fa-list-alt"></i> Todos los Horarios</a></li>
                    ...
                    ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="schedule/timeSchedule"><i class="fa fa-list-alt"></i>Todos los Horarios</a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Laboratorist'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                ...
                                <span><?php echo 'Laboratorio' ?></span>
                            </a>
                            <ul class="sub">
                            ...
                            <ul class="sub">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                                    <li class="sub-menu">
                                        ...
                                        <ul class="sub">
                                            <li><a href="finance/pharmacy/financialReport"><i class="fa fa-book"></i>Punto de Venta <?php echo lang('report'); ?> </a></li>
