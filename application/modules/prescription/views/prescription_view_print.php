            ...
            <div class="bg_prescription">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        <h5 class="col-md-3 prescription"><?php echo  'Recetas' ?> <?php echo lang('id'); ?> : <?php echo $prescription->id; ?></h5>
                    </div>
                </div>
            ...
            <div class="panel-primary clearfix">
                ...
                <div class="panel_button clearfix">
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <div class="text-center invoice-btn no-print pull-left">
                            <a class="btn btn-info btn-lg info" href='prescription/all'><i class="fa fa-medkit"></i> <?php echo lang('all'); ?> <?php echo  'Recetas' ?> </a>
                        </div>
                    <?php } ?>
